...
#---------------------------------------------------------------------------------
# Submission script for SMARTCV with model_id=1 and exp_id=0 (exp1), 3 (exp4)
#---------------------------------------------------------------------------------

echo "Submitting SMARTCV jobs for model_id=1 and exp_id in {0,3}..."
...
#SBATCH --job-name=smartcv_m1e${EXP_ID}
#SBATCH --array=0-99

echo "Job ID: \$SLURM_JOB_ID"
echo "Job User: \$SLURM_JOB_USER"
echo "Running SMARTCV model_id=1, exp_id=${EXP_ID}, rd_seed_id=\${SLURM_ARRAY_TASK_ID}"
...
echo "All SMARTCV jobs submitted for model_id=1."
