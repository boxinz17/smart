...
#---------------------------------------------------------------------------------
# Combined submission script for SMART with model_id=1 and exp_id=0,1,2,3
#---------------------------------------------------------------------------------

echo "Submitting SMART jobs for model_id=1 and exp_id in {0,1,2,3}..."
...
#SBATCH --job-name=smart_m1e${EXP_ID}
#SBATCH --array=0-99

echo "Job ID: \$SLURM_JOB_ID"
echo "Job User: \$SLURM_JOB_USER"
echo "Running SMART model_id=1, exp_id=${EXP_ID}, rd_seed_id=\${SLURM_ARRAY_TASK_ID}"
