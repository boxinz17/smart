...
# === Run SRRR ===
cat("Running SRRR...\n")
srrr_fit <- srrr(Y_source, X_source, nrank = r_hat, method = "adglasso", ic.type = "BIC")
C_hat_srrr <- srrr_fit$coef

# === Save result ===
np$save(file.path(output_dir, "source_matrix_SRRR.npy"), C_hat_srrr)
cat("SRRR estimation saved successfully.\n")
